...
class NexusAnnotations:
    ...
    def __init__(
        self,
        colour_dict=matplotlib_colours,
        symbol_list=symbols,
        tree=None,
        node_annotations=defaultdict(list),
        leaf_annotations=defaultdict(list),
    ...
    def add_colour_annotation(
        self, node, colour=None, random_colour=False, colour_descendants=True
    ):
        """
    ...
    def add_colour_annotations(self, nodes, colour_list=None, colour_descendants=False):
        ...
        for index, node_set in enumerate(nodes):
            ...
            for node in node_set:
                self.add_colour_annotation(
                    node, set_colour, colour_descendants=colour_descendants
                )
